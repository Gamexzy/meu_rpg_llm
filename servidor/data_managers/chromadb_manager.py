...
class AddOrUpdateLoreArgs(BaseModel):
    ...
    metadata: Dict = Field(description="Um dicionário contendo metadados. Ex: {'tipo': 'local', 'nome': 'Cygnus Prime'}.")
...
class ChromaDBManager:
    ...
    def add_or_update_lore(self, session_name: str, id_canonico: str, text_content: str, metadata: dict) -> bool:
    ...
    def query_lore(self, session_name: str, query_text: str, n_results: int = 5) -> List[str]:
        ...
        try:
            ...
            # Retorna apenas a lista de textos (documentos)
